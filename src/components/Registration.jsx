...
const Registration = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault()
        console.log(e)
        if (formField.password.value === formField.passwordRepeat.value) {
            console.log("success")
            console.log()
        } else {
            <Alert>Passwords doesn't match</Alert>
                ...
                <Col>
                    <div >
                        ...
                        <form onSubmit={onSubmit} className="form-container">
                            ...
                            <input type="password" placeholder="Repeat password" id="password-repeat" onChange={(e) => handleInput(['passwordRepeat'], e.target.value)} />
